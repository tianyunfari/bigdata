...
import com.bigdata.dao.MetaLogDao;
import com.bigdata.dao.MetaLogFieldDao;
import com.bigdata.factory.NginxFactory;
import com.bigdata.model.NginxLogModel;
import com.bigdata.pojo.MetaLog;
import com.bigdata.pojo.MetaLogField;
    ...
    public static class MyMapper extends Mapper<LongWritable, Text,
        ...
        protected void map(LongWritable key, Text value, Context context)
            ...
            try {
                ...
                this.multipleOutputs.write(this.keyText, NullWritable.get(),
                        metaLog.getHdfsBaseOutput() + "/" + day + "/part");
