package com.bigdata.format;

import com.bigdata.dao.AbstractDMDAO;
import com.bigdata.dao.DMIPRuleDAO;
import com.bigdata.dao.DMInterURLDAO;
import com.bigdata.dao.DMOuterURLRuleDAO;
import com.bigdata.enums.ConstantEnum;
import com.bigdata.enums.PvEnum;
import com.bigdata.enums.UtilComstrantsEnum;
...
public class PvForMatMR extends Configured implements Tool {
    ...
    public static class PvForMatMap extends Mapper<
        ...
        public String getPVFormatStr(String originalData) throws Exception {
            ...
            try {
                ...
                String urlInfo = StringDecodeFormatUtil.decodeCodedStr(urlInfoRegion, charset)
                        .replaceAll("\\s+", "");
    ...
    public static void main(String[] args) throws Exception {
        int ec = ToolRunner.run(new Configuration(), new PvForMatMR(), args);
