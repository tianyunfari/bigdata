...
public class UserBehaviorService
{
  ...
  public BaseResult handleAppUseInfo(AppUseInfoRequest appUseInfoRequest)
  {
  ...
  * */
  public List<PackageTimeLenModel> getUserAppStat(String beginDay, String endDay, long userId)
  {
    ...
    //for (String month : monthList) {
      ...
      String startRowKey = MyStringUtil.getFixedLengthStr(userId + "", 10) + ":" + beginDay; // 0000001000:20171105
